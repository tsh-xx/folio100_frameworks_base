...
static char* convertToUtf8(const char* in)
{
    ...
    buf = SharedBuffer::alloc(requiredLen+1);
...
String8::String8(bool toUtf8, const char* o)
{
    if (toUtf8 == true) {
        mString = convertToUtf8(o);
    }
    else {
        mString = allocFromUTF8(o, strlen(o));
    }
