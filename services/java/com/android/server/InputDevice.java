...
public class InputDevice {
    ...
    /** Amount that Mouse needs to move in order to generate a key event. */
    static final int MOUSE_MOVEMENT_THRESHOLD = 1;
    ...
    final MotionState mMouseRel = new MotionState(MOUSE_MOVEMENT_THRESHOLD,
    ...
    static class MotionState {
        ...
        MotionEvent generateMouseMotion(InputDevice device, long curTime,
                long curTimeNano, int orientation, int metaState) {
