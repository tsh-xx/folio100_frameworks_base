...
public class Camera {
    ...
    public class Parameters {
        ...
        private static final String KEY_CAMERA_SENSOR = "camera-sensor";
...
<<<<<<< HEAD
        ...
        /**
         * @hide
         * Sets required Camera sensor.
         *
         * @param Id of Camera sensor.  The range is 0 to N-1,
         *        where N is number of sensors available on the platform.
         */
        public void setCameraSensor(int sensorId) {
            set(KEY_CAMERA_SENSOR, sensorId);
        }

        /**
         * @hide
         * Returns Id of currently active Camera sensor.
         *
         * @return Id of currently active Camera sensor.
         */
        public int getCameraSensor() {
            return getInt(KEY_CAMERA_SENSOR);
        }
	 ...
	 *
	 */
        public void setVideoStabilizationMode(int vstabMode) {
            set(KEY_VIDEO_STABILIZATION, vstabMode);
        }

        /**
         * @hide
         * Returns current Video Stabilization mode.
         *
         * @return value (0,1)
         */
        public int getVideoStabilizationMode() {
            return getInt(KEY_VIDEO_STABILIZATION);
        }
